...
const Page = ({ params }) => {
  ...
  const course = courseDetails.find((curElem) =>
    curElem.title.toLowerCase().includes(slug.toLowerCase()),
  );
      ...
      >
        ...
        >
          <div className="card-body text-center">
            ...
            <span className="badge bg-gradient bg-primary px-3 py-3 mx-2">
              <FaClock /> {course.duration}
            </span>

            <span className="badge bg-gradient bg-success px-3 py-3">
